...
var server = http.createServer(function (req, res) {
    if (req.url == '/') { 
        ...
        res.write('<html><body><h1 style="color:green;">Welcome to Linh Website v0.1</h1></body></html>');
        res.end();
    }
    else if (req.url == "/training") {
        res.writeHead(200, { 'Content-Type': 'text/html' });
        res.write('<html><body><h1 style="color:blue;">Welcome to Training page v0.1!</h1></body></html>');
        res.end();
    }
